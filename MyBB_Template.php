...
class MyBB_Template {
	...
	public function update($title, $template)
	{
		$time = time();
	...
	public function insert($title, $template)
	{
		$time = time();
	...
	public function store($quiet = false)
	{
	...
	public function sync_all($quiet = false)
	{
		$total = 0;
